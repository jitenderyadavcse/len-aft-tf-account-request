module "len-aws-mlops-dev" {
  source = "../aft-account-request"
 
  control_tower_parameters = {
    AccountEmail              = "len-aws-mlops-dev@lennar.com"
    AccountName               = "len-aws-mlops-dev"
    ManagedOrganizationalUnit = "DEV-Shared-Platform (ou-0yph-ju33s43m)"
    SSOUserEmail              = "len-aws-mlops-dev@lennar.com"
  ...
  change_management_parameters = {
    ...
    change_reason       = "Account to support MLOps Development"
  }
  ...
  custom_fields = {
    ...
    role_mappings = <<EOR
    {
      "EngineeringContributor": "len-aws-mlops-dev-EngineeringContributor",
      "Reader": "len-aws-mlops-dev-ReadOnly"
    }
    EOR
    mandatory_tags = <<EOT
    {
